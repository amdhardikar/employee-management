...
import { normalizePhone, validateEmployee } from "../../../src/utils/employeeValidation";
...
describe("validateEmployee", () => {
	it("normalizes every supported Indian phone format before validation", () => {
		expect(normalizePhone("+91 9876548978")).toBe("+919876548978");
		expect(normalizePhone("+919876786543")).toBe("+919876786543");
		expect(normalizePhone("9876564324")).toBe("9876564324");
		...
		const employee = {
			...
			personalInfo: {
				...
				phone: "+91 9876548978",
				alternatePhone: "+919876786543",
			},
			emergencyContact: {
				...validEmployee.emergencyContact,
				phone: "9876564324",
			},
		};
