...
import AttendanceDetailsTable from "../../../../src/components/attendance/AttendanceDetailsTable";

vi.mock("../../../../src/utils/attendance.util", () => ({
	getAttendancePercentageColor: vi.fn(() => "text-green-600"),
}));

describe("AttendanceDetailsTable", () => {
	beforeEach(async () => {
		const { getAttendancePercentageColor } = await import("../../../../src/utils/attendance.util");
