...
import PayrollTable from "../../../../src/components/payroll/PayrollTable";
...
describe("PayrollTable", () => {
	...
	it("renders assignment fallbacks when employment data is missing", () => {
		render(<PayrollTable payrolls={[{ ...payrolls[0], employment: null }]} onView={vi.fn()} />);
