...
import DepartmentCard from "../../../../src/components/department/DepartmentCard";
...
describe("DepartmentCard", () => {
	...
	it("calls onView when eye action is clicked", () => {
		...
		const button = screen.getByRole("button", { name: "View department" });
	...
	it("calls edit and delete actions with the department", () => {
		const onEdit = vi.fn();
