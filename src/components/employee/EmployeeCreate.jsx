...
const EmployeeCreate = () => {
	...
	return (
		<div className="flex flex-col gap-6 overflow-y-auto border-t border-slate-200">
						...
						<Input
							...
							onChange={(e) => {
								...
								updateNestedField(
									"personalInfo",
									"profileImage",
									`https://ui-avatars.com/api/?name=${employee.personalInfo.firstName}%20${e.target.value}&background=random&color=fff&bold=true`,
								);
							}}
						/>
